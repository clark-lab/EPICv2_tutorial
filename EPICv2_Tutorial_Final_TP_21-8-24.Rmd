...
probeIDs <- EPICv2manifest$IlmnID[c(which(EPICv2manifest$CHR=="chr19" & EPICv2manifest$MAPINFO==53738870),
                                    which(EPICv2manifest$Suggested_offtarget==names(probes)[2]),
                                    which(EPICv2manifest$Suggested_offtarget==names(probes)[3]))]
betas <- beta_v2.clean2[probeIDs, ]
melt <- melt(betas)
